...
** This code is designed for use by myself with the 
** specific condictions as following:
** pH=13.64, ref=SCE, separator=space
*******************************************************/
#include <stdlib.h>
#include <stdio.h>
#include <guancai.c>
...
{
	FILE *data,*out,*inter;
	int i=0,j,k,filenum,rows,txtnum,md;
	...
	for(i=0;i<txtnum;i++)
	{
        ...
        if(!method){
            ...
            printf("%s file is a %s characterization.\n",fname[i], method);
